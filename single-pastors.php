    ...
    while (have_posts()) :
        ...
        <div class="page"
            ...
            <div class="page__header">
                <h1 class="page__title animate__animated animate__zoomIn">Our Pastors</h1>
            </div>
        ...
        <div class="section section-light">
            <div class="article__content">
                <div class="section__title single__title">
                    <h1 class="heading-1 color-blue single-heading"><?php the_title(); ?></h1>
                    <span class="dash"></span>
                    <span><span><a href="<?= get_site_url() ?>/pastors/" class="color-gold">Pastors</a></span></span>
                </div>
                <?php the_content(); ?>
            </div>
        </div>
